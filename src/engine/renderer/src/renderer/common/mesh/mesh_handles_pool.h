#pragma once
#include "interface_mesh_accessor.h"
...
namespace enishi::renderer {
    class MeshPool : public IMeshAccessor {
      private:
        struct MeshHandle {
      ...
      public:
        ...
        foundation::Option<MeshPool::MeshHandles&> get_mesh_handles(
            const types::HandleId handle) noexcept override;
        foundation::Option<const MeshPool::MeshHandles&> get_mesh_handles(
