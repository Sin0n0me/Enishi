...
namespace enishi::renderer {
    class ModelToMesh {
      ...
      public:
        ...
        [[nodiscard]] static foundation::Result<types::MeshData, RendererError> to_mesh_data(
      ...
      private:
        ...
        [[nodiscard]] static foundation::Result<types::MeshMaterial::BindTextureMap, RendererError>
