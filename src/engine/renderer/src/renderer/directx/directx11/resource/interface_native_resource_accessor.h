...
#include "state/interface_native_state_accessor.h"
...
namespace enishi::renderer::directx {
    class INativeResourceAccessor {
      public:
        ...
        [[nodiscard]] virtual const INativeBufferAccessor* get_native_buffer_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeInputLayoutAccessor* get_native_input_layout_accessor(
            void) noexcept = 0;
        [[nodiscard]] virtual const INativeInputLayoutAccessor* get_native_input_layout_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeTextureAccessor* get_native_texture_accessor(
            void) noexcept = 0;
        [[nodiscard]] virtual const INativeTextureAccessor* get_native_texture_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeShaderAccessor* get_native_shader_accessor(void) noexcept = 0;
        [[nodiscard]] virtual const INativeShaderAccessor* get_native_shader_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeViewAccessor* get_native_view_accessor(void) noexcept = 0;
        [[nodiscard]] virtual const INativeViewAccessor* get_native_view_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeViewportAccessor* get_native_viewport_accessor(
            void) noexcept = 0;
        [[nodiscard]] virtual const INativeViewportAccessor* get_native_viewport_accessor(
            void) const noexcept = 0;

        [[nodiscard]] virtual INativeStateAccessor* get_native_state_accessor(void) noexcept = 0;
        [[nodiscard]] virtual const INativeStateAccessor* get_native_state_accessor(
            void) const noexcept = 0;
    };
} // namespace enishi::renderer::directx